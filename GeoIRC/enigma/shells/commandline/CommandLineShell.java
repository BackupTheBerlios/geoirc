...
import enigma.shells.commandline.commands.*;
import enigma.util.*;
...
public class CommandLineShell {
    ...
    private Map compatibilityAliases = new HashMap();
    ...
    public void runShell() {
        ...
        System.out.println("This is a preview version of the Enigma shell, intended");
        System.out.println("to demonstrate some of the Console API's capabilities.");
        System.out.println("Command support is minimal at the moment.");
        System.out.println();
    ...
    public void processCommand(String[] tokens) {
        ...
        if (compatibilityAliases.containsKey(command)) {
            ...
            System.out.println(Util.msg(getClass(), "compatibility.alias", 
    ...
    private void processExternalCommand(final String[] tokens) {
        ...
        if (match == null) {
            System.out.println(Util.msg(getClass(), "command.not.found", new String[] { tokens[0] }));
            System.out.println();
            return;
        }
