...
public class Cd {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            System.out.println(Util.msg(Cd.class, "usage.info"));
            return;
        }
        else if (args.length > 1) {
            System.out.println(Util.msg(Cd.class, "too.many.arguments", new Object[] { Arrays.asList(args) }));
            return;
        }
        ...
        if (path.exists()) {
            ...
            System.out.println(Util.msg(Cd.class, "path.not.found", new Object[] { path }));
    }
}
