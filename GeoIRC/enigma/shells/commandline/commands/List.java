...
public class List {
    ...
    private static final Comparator fileComparator = new Comparator() {
    ...
    private void listPaths(String[] paths) {
        ...
        System.out.println(Util.msg(List.class, "list.totals", 
    ...
    private void list(String path) {
        ...
        try {
            ...
            System.out.println(Util.msg(List.class, "file.not.found", new String[] { path }));
            return;
        }
