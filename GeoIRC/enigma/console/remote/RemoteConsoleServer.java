...
public class RemoteConsoleServer implements Console {
    ...
    private static void spawn(final Socket s, final String className, final String[] args) {
        ...
        new Thread("Subprocess") {
            public void run() {
                ...
                System.out.println(Util.msg(RemoteConsoleServer.class, "connection.received", new Object[] { address }));
                ...
                try {
                    ...
                    System.out.println(Util.msg(RemoteConsoleServer.class, "connection.dropped", new Object[] { address }));
                }
            }
        }.start();
    }
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("WARNING: Authentication is not implemented.  All connections will be allowed.");
        int port = 23;
        ServerSocket server = new ServerSocket(port);
        System.out.println(Util.msg(RemoteConsoleServer.class, "listen.port", new Object[] { new Integer(port) }));
        for (;;) {
