...
public class ConnectionPane extends BaseSettingsPanel implements Storable
{
     ...
     * @param name
     */
    public ConnectionPane(XmlProcessable settings, GeoIRCDefaults valueRules, String name)
    {
    ...
    public void initialize()
    {
        ...
        addComponent(new JLabel("Default download directory"), 0, 2, 1, 1, 0, 0, new Insets(5, 5, 2, 5));
